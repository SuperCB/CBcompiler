...
void StmtVisitor::Visit(Assign *assignst) {

}

void StmtVisitor::Visit(DeclStmt *declst) {

}

void StmtVisitor::Visit(Binary *binst) {

}

void StmtVisitor::Visit(While *whilest) {

}

void StmtVisitor::Visit(If *ifst) {

}

void StmtVisitor::Visit(Return *returnst) {

}

void StmtVisitor::Visit(ExprStmt *exprst) {

}

void StmtVisitor::Visit(Continue *continst) {

}

void StmtVisitor::Visit(Break *breakst) {
